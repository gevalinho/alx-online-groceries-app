...
// 🧩 Sample product data
const DATA = [
  { id: "1", name: "Organic Bananas", info: "7pcs, Priceg", price: 4.99, image: require("../../assets/images/bananas.png") },
  { id: "2", name: "Red Apple", info: "1kg, Priceg", price: 4.99, image: require("../../assets/images/apple.png") },
  { id: "3", name: "Bell Pepper Red", info: "1kg, Priceg", price: 4.99, image: require("../../assets/images/pepper.png") },
  { id: "4", name: "Ginger", info: "250gm, Priceg", price: 4.99, image: require("../../assets/images/ginger.png") },
  { id: "5", name: "Beef Bone", info: "1kg, Priceg", price: 4.99, image: require("../../assets/images/beef.png") },
  { id: "6", name: "Broiler Chicken", info: "1kg, Priceg", price: 4.99, image: require("../../assets/images/chicken.png") },
];

// 🥦 Groceries horizontal section data
const GROCERIES = [
  { id: "1", name: "Pulses", image: require("../../assets/images/pulses.png"), bgColor: "#FFF6ED" },
  { id: "2", name: "Rice", image: require("../../assets/images/rice.png"), bgColor: "#F2F9F3" },
  { id: "3", name: "Vegetables", image: require("../../assets/images/vegetables.png"), bgColor: "#EBF8FF" },
  { id: "4", name: "Fruits", image: require("../../assets/images/bananas.png"), bgColor: "#FFF1F1" },
];
...
const ProductCard = ({ item }: { item: any }) => {
  ...
  return (
    <TouchableOpacity
      ...
      className="bg-white w-[48%] p-3 rounded-2xl mb-4 border border-gray-100 shadow-sm"
    >
      <Image source={item.image} resizeMode="contain" className="w-full h-24 mb-3" />
    ...
    <FlatList
      ...
      renderItem={({ item }) => (
        <TouchableOpacity
          ...
          activeOpacity={0.8}
        >
          <Image source={item.image} style={{ width: 45, height: 45, marginBottom: 8 }} resizeMode="contain" />
          <Text style={{ fontSize: 15, fontWeight: "600", color: "#1F232B" }}>{item.name}</Text>
        </TouchableOpacity>
      )}
    />
  </View>
    ...
    <View className="flex-1 bg-[#F9FAFB]">
      ...
      <View className="mx-5 mt-4 bg-white flex-row items-center rounded-xl p-3 border border-gray-100">
        ...
        <TextInput
          ...
          className="ml-2 flex-1 text-gray-800 text-[15px]"
        />
      </View>
